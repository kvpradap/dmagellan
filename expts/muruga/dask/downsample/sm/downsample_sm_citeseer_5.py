...
# 5% 
lstopwords = ['of', 'and', 'for', 'the', 'in', 'on', 'to', 'with'] 
rstopwords = ['inproceedings', 'article', 'of', 'for', 'and', 'in', 'the', 'on', 'with', 'systems', 'to', 'using', 'ieee', 'an', 'networks', 'based']
...
C = downsample_sm(A, B, 'id', 'id', 100000, 1, lstopwords=lstopwords, rstopwords=rstopwords)
