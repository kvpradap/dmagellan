...
datapath = "../datasets/"
A = pd.read_csv(os.path.join(datapath, 'sample_tracks.csv'))
B = pd.read_csv(os.path.join(datapath, 'sample_songs.csv'))
...
print('\ndask')
start = time.time()
res = downsample_dk(A, B, "id", "id", 10000, 1, stopwords=stopwords, nlchunks=1, nrchunks=1)
